...
module.exports.run = async (bot, message, args) => {
    ...
    if(!cName.startsWith("commands")) { 
        message.reply("You can't use -management here!")
        .then(msg => {
            msg.delete(5000)
          })
    }
    ...
    message.guild.createChannel(`management-${message.author.username}`, "text").then(c => {
	...
	c.overwritePermissions(role3, {
        ...
        .setColor("#ffffff")
        .addField(`Discord Console`,`${message.author} created a management ticket!\nTicket: ${c}`)
        .setTimestamp()
        ...
        .addField(`How to go to my management ticket?`, `Click on ${c}`)
        .setTimestamp()
        .setFooter(`© Limit`, "https://imgur.com/KOA8OVl.png")
