...
module.exports.run = async (bot, message, args) => {
    ...
    if(!cName.startsWith("commands")) { 
        message.reply("You can't use -suggestion here!")
        .then(msg => {
            msg.delete(5000)
          })
    }
    ...
    message.guild.createChannel(`suggestion-${message.author.username}`, "text").then(c => {
	...
	c.overwritePermissions(role3, {
        ...
        .setColor("#ffffff")
        .addField(`Discord Console`,`${message.author} created a suggestion ticket!\nTicket: ${c}`)
        .setTimestamp()
        ...
        .addField(`How to go to my suggestion ticket?`, `Click on ${c}`)
        .setTimestamp()
        .setFooter(`© Limit`, "https://imgur.com/KOA8OVl.png")
